...
public class E4ArrayUtils {
   ...
   return sum;
    ...
    public static void main(String[] args) {
        ...
        /*we are calling the "add" method on the "obj" object passing two arguments
         one it 10 other is 20 and storing the results from method call into the sum variable
